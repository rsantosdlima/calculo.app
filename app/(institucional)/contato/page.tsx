...
// (Metadados não funcionam em Client Components, mas podemos deixar aqui se no futuro a página virar Server Component)
// export const metadata: Metadata = {
//   title: "Contato | Calculo.App",
//   description: "Entre em contato com a equipe do Calculo.App para dúvidas, sugestões ou parcerias.",
// };
